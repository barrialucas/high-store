                ...
                <div className="row d-flex align-items-center footer__derecha">
                    ...
                    <div className="footer__iconos col-8 col-md-8 col-lg-8 col-xl-7 col-xxl-7">
                        <div className="d-flex flex-row high align-items-center">
                            ...
                            <a href="https://www.instagram.com/high.store_9410/">high-store.9410</a>
                        </div>
                        <div class="d-flex flex-row whats">
                            ...
                            <a className="texto-wsp" href="https://api.whatsapp.com/send?phone=542901580214&text=Hola%20deseo%20mas%20informaci%C3%B3n%20acerca%20del%20los%20tipos%20de%20lentes.">2901580214</a>
                        </div>
                    </div>
                </div>
            </div>
